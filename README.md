...
get the app created:
    ...
    $ heroku apps:create heroku-test
    Creating heroku-test... done, stack is cedar
    http://heroku-test.herokuapp.com/ | git@heroku.com:heroku-test.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://heroku-test.herokuapp.com deployed to Heroku

    To git@heroku.com:heroku-test.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://heroku-test.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@heroku-test.herokuapp.com/repl
